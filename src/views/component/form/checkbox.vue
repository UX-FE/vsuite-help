        ...
        <div class="mItem">
            ...
            <div class="wrap">
                <CheckboxGroup v-model="checkbox3.check" :min="1" :max="2">
                    <Checkbox v-for="(item,index) in checkbox3.boxs" :key="index" :value="item.value" :label="item.name">{{item.label}}</Checkbox>
                </CheckboxGroup>
                {{checkbox3.check}}
                <br/>
                <div class="q-title">说明：</div>
                ...
                <div class="q-title">代码示例：</div>
                <DCode :code="code.min" lang="html"></DCode>
            </div> -->
            <!-- <div class="title2">
                类型：
            </div>
            <div class="wrap">
                ...
                <br/>
                <br/>
                <CheckboxGroup v-model="type.check">
                    <Checkbox type="button" v-for="(item,index) in type.boxs" :key="index" :value="item.value" :label="item.name">{{item.label}}</Checkbox>
                </CheckboxGroup>
                <br/>
                <br/>
                <CheckboxGroup v-model="type.check">
                    <Checkbox type="bordered" v-for="(item,index) in type.boxs" :key="index" :value="item.value" :label="item.name">{{item.label}}</Checkbox>
                </CheckboxGroup>
                <br/>
                <div class="q-title">说明：</div>
                <div>
            ...
            <div class="wrap">
                <CheckboxGroup v-model="checkbox2.check">
                    <Checkbox v-for="(item,index) in checkbox2.boxs" :key="index" :value="item.value">
            ...
            <div class="wrap">
                <Checkbox v-model="all.isCheckAll">全选</Checkbox>
                <br/>
                <br/>
                <CheckboxGroup v-model="all.check" @on-change="handleCheckAll">
                    <Checkbox v-for="(item,index) in all.boxs" :key="index" :value="item.value">
                        <Icon type="android-cloud"></Icon>自定义的box{{index}}
                    </Checkbox>
                </CheckboxGroup>
                {{all.check}}
            ...
            <div class="wrap">
                <CheckboxGroup v-model="checkbox2.check">
                    <Checkbox :icon-type="checkbox2.iconType" v-for="(item,index) in checkbox2.boxs" :key="index" :value="item.value" :label="item.name">{{item.label}}</Checkbox>
                </CheckboxGroup>
                {{checkbox2.check}}
                <div class="q-title">说明：</div>
                <div>
            ...
            <div class="wrap">
                ...
                <div class="q-title">CheckBoxGroup【events】：</div>
                <Table type="bordered" :thead="event1.thead" :data="event1.data">
                </Table>
            </div>
        </div>
        <DMenu></DMenu>
